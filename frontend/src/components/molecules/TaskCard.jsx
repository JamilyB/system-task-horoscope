...
export const TaskCard = ({ descricao, data, time, onDelete, onEdit }) => {
  return (
    <div className="card p-3 mb-2 shadow-sm d-flex justify-content-between align-items-start flex-row">
      <div>
        ...
        <small className="text-muted d-block">Data: {data}</small>
        <small className="text-muted d-block">Hora: {time}</small>
      </div>
      <div className="ms-2">
